...
module.exports = {
    ...
    async execute (client, member) {
        const welcomeChannel = member.guild.channels.cache.get("1090332036058861718");
        const welcomeChannel2 = member.guild.channels.cache.get("1089200272632467518");
...
Enjoy your stay - make the new member feel welcome 🛬`;
    ...
    const welcomeEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                {name: `:speaking_head:`, value: `Chat with the community in <#1090334254505922681>.`},
